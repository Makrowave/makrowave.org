  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
      <Badge
        ...
        badgeInset={"8%"}
        badgeContent={
          <Link href={"https://www.youtube.com/watch?v=2_Dtmpe9qaQ"} target='_blank'>
            <Avatar
              alt='Clippy'
      ...
      <Link href='https://bsky.app/profile/makrowave.bsky.social' sx={{ gap: 1 }} target='_blank'>
        <BlueskyIcon />
        Bluesky
      </Link>
      <Link href='https://steamcommunity.com/id/Makrowave' sx={{ gap: 1 }} target='_blank'>
        <SteamIcon />
        Steam
      </Link>
