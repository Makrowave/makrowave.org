...
<CustomSyntaxHighlighter language="css">
  {`p {
    color: 'red';
}`}
...
<CustomSyntaxHighlighter language="typescript">
...
<CustomSyntaxHighlighter language='markdown'>
{`import Link from '@mui/material/Link';
import Box from '@mui/material/Box';
...
Fun fact: here something broke - this should have tsx formatting not markdown, and rest of highlighting in vscode is a template string.
But it compiles! (This app is served to you with static files... and TS ofc)
...
But little HTML to help with style sometimes is ok.
Also - code highlighting - I use **react-syntax-highlighting** and insert my custom highlight for every code snippet in MDX file.
