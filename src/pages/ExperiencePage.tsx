import { Avatar, Box, Divider, Step, StepIndicator, Stepper, Typography } from "@mui/joy";

const ExperiencePage = () => {
  return (
    <Box sx={{ display: "flex", flex: 1, m: "40px" }}>
      <Stepper orientation='vertical' sx={{ flex: 3, "--Step-gap": "80px", "--StepIndicator-size": "35px" }}>
        <Step
          indicator={
            <StepIndicator
              sx={{
          ...
          sx={{
            "&::after": {
              height: 2,
              borderRadius: "24px",
              background: "linear-gradient(180deg,rgba(78, 245, 184, 1), rgba(209, 255, 186, 1))",
            },
          }}
        >
          <Box>
        ...
        <Step
          ...
          sx={{
            "&::after": {
              height: 2,
              borderRadius: "24px",
              background: "linear-gradient(180deg,rgba(78, 245, 184, 1), rgba(255, 255, 255, 1))",
            },
          }}
        >
          <Box>
